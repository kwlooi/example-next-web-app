...
const Jumbotron = () => (
  <>
    ...
    `}</style>
    <div
      className="jumbotron jumbotron-fluid bg-dark mb-0"
    ...
    >
      <div className="container text-white">
        <h1 className="display-2 text-white d-none d-lg-block">
          Elevate your work style always
        </h1>
        <h1 className="display-4 text-white text-center d-lg-none">
          Elevate your work style always
        </h1>
        <p className="lead text-center">
          Transform the way you work, meet clients and collaborate with an
          inspiring and unique office experience.
        </p>
        <hr className="my-4" />
        <Link href="/locations">
